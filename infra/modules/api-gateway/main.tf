...
resource "aws_api_gateway_integration" "eventbridge_integration" {
  ...
  uri                     = "arn:aws:apigateway:${data.aws_region.current.name}:lambda:path/2015-03-31/functions/${var.api_proxy_lambda_arn}/invocations"
...
resource "aws_lambda_permission" "api_gateway" {
  ...
  function_name = var.api_proxy_lambda_arn
