...
const ENTRY_POINT = 'services/api-proxy.ts';
const OUTPUT_DIR = 'dist/api-proxy';
const ZIP_FILE = 'dist/api-proxy.zip';
...
async function runBuild(): Promise<void> {
  try {
    ...
    // Step 5: Create zip
    createZip();
    console.log('Build + zip ready at dist/api-proxy.zip');
  } catch (error) {
